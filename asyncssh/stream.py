...
class SSHReader(Generic[AnyStr]):
    ...
    async def readuntil(self, separator: object, separator_len: int = None) -> AnyStr:
        ...
        return await self._session.readuntil(separator, self._datatype, separator_len)
...
class SSHStreamSession(Generic[AnyStr]):
    ...
    async def readuntil(self, separator: object, datatype: DataType, separator_len: int) -> AnyStr:
